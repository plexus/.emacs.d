...
;; Version: 0.1.0
;; Package-Requires: ((a) (aggressive-indent) (avy) (cider) (clj-refactor) (clojure-mode) (company) (counsel) (counsel-projectile) (diminish) (dumb-jump) (elisp-slime-nav) (evil) (evil-cleverparens) (evil-collection) (evil-magit) (evil-surround) (expand-region) (goto-last-change) (ivy) (magit) (markdown-mode) (org) (projectile) (rainbow-delimiters) (smartparens) (smex) (string-edit) (swiper) (undo-fu) (which-key) (winum) (yaml-mode))
...
(setq corgi-straight-original-profile straight-current-profile)
(setq straight-current-profile 'corgi)

(let ((version-file-source (expand-file-name "corgi-versions.el" (or load-file-name buffer-file-name)))
      (version-file-target (expand-file-name "versions/corgi.el" straight-base-dir)))
