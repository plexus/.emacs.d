;; Taken from emacs-live. It extends the flashing functionality
;; provided by eval-sexp-fu to also work with Clojure/Cider. Seems
;; this could be a package in its own right, would need to figure out
